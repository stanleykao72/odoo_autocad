...
# -*- coding: utf-8 -*-
"""
Integration test for MCP SDK Server
"""
...
class MCPSDKIntegrationTester:
    """Test the MCP SDK server integration"""
    
    def __init__(self):
        self.server_path = os.path.join(os.path.dirname(__file__), '..', '..', 'mcp_server_sdk.py')
        self.server_process = None
    
    def start_server(self):
        """Start the MCP SDK server process"""
        try:
            ...
            print(f"✓ MCP SDK Server started with PID: {self.server_process.pid}")
            return True
    ...
    def stop_server(self):
        """Stop the MCP SDK server process"""
    ...
    def run_integration_tests(self):
        ...
        print("🔄 Starting MCP SDK Server Integration Tests...")
...
if __name__ == "__main__":
    ...
    tester = MCPSDKIntegrationTester()
    success = tester.run_integration_tests()
    
    if success:
        print("\n🎉 All integration tests passed!")
        print("   MCP SDK Server is ready for use with Gemini CLI")
        sys.exit(0)
    else:
